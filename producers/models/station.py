...
class Station(Producer):
    ...
    # (DONE)TODO: Define this value schema in `schemas/arrival_value.json, then uncomment the below
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        # (DONE)TODO: Complete this function by producing an arrival message to Kafka
